...
export class EmployeeEdit extends Component {
   ...
   async getEmployee(id) {
      ...
      this.setState({ id: data.id, fullName: data.fullName, birthdate: format(data.birthdate, 'yyyy-MM-dd'), tin: data.tin, employeeTypeId: data.employeeTypeId, loading: false, loadingSave: false });
   }
}
